...
export default function Home() {
  return (
    <main className="policy-page">
      <nav className="site-nav policy-nav" aria-label="Privacy policy navigation">
        <Link className="brand" href="/" aria-label="Lippi home">
          <Mark />
          <span>Lippi</span>
        </Link>
      ...
      <section className="privacy-hero" id="top">
