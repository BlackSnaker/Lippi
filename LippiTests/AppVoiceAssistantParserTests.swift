...
struct AppVoiceAssistantParserTests {
    ...
    func assistantLocalizationKeysResolve() {
        let keys = [
            ...
            "assistant.hero.ready.title",
            "assistant.hero.ready.subtitle",
            "assistant.hero.listening.title",
            "assistant.hero.listening.subtitle",
            "assistant.hero.processing.title",
            "assistant.hero.processing.subtitle",
            "assistant.hero.speaking.title",
            "assistant.hero.speaking.subtitle",
            "assistant.hero.error.title",
            ...
            "assistant.quick.eye",
            "assistant.command.add.title",
            "assistant.command.smart_goal.title",
            "assistant.command.goal_progress.title",
            "assistant.command.tasks.title",
            "assistant.command.calendar.title",
            "assistant.command.care.title",
            "assistant.command.summary.title",
            "assistant.command.pomodoro.title",
            "assistant.command.pause.title",
            "assistant.command.resume.title",
            "assistant.command.break.title",
            "assistant.command.eye.title",
            "assistant.commands.all",
            "assistant.commands.all.subtitle",
            "assistant.keyboard.title",
            "assistant.keyboard.placeholder",
            "assistant.keyboard.send",
            "assistant.keyboard.hint",
            "assistant.hint.tap_hold",
            "assistant.button.start",
            "assistant.button.stop",
            "assistant.button.close",
            "assistant.button.keyboard",
            "assistant.button.commands",
